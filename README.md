...
CC Desktop Switch 是一个轻量桌面工具，用本地浏览器界面管理第三方 API 提供商，并把 Claude Desktop 的第三方推理请求转发到 DeepSeek、Kimi、七牛云、智谱等平台。
...
- `CC-Desktop-Switch-v1.0.0-Windows-Setup.exe`：安装版
- `CC-Desktop-Switch-v1.0.0-Windows-Portable.zip`：便携版
